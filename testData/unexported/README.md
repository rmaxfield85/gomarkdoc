...
```go
import "github.com/rmaxfield85/gomarkdoc/testData/unexported"
```
...
## type [Num](<https://github.com/rmaxfield85/gomarkdoc/blob/master/testData/unexported/main.go#L8>)
...
### func [AddNums](<https://github.com/rmaxfield85/gomarkdoc/blob/master/testData/unexported/main.go#L16>)
